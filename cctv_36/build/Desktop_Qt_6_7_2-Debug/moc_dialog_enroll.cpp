...
struct qt_meta_stringdata_CLASSEnrollDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSEnrollDialogENDCLASS = QtMocHelpers::stringData(
    "EnrollDialog",
    "dataSubmitted",
    "",
    "clicked_buttonPrev",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSEnrollDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject EnrollDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSEnrollDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSEnrollDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSEnrollDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void EnrollDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (EnrollDialog::*)();
            if (_t _q_method = &EnrollDialog::dataSubmitted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *EnrollDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSEnrollDialogENDCLASS.stringdata0))
